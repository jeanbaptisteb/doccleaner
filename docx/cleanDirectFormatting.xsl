...
<xsl:param name="paramTest" value="oui"/>
<!-- Nettoyer le xml de sortie -->
...
<!-- on ne garde que : gras, italique, souligné, exposant, indice, langue -->
    <xsl:template match="*/w:rPr">
		<xsl:copy>
			<xsl:copy-of select="w:b" />
			<xsl:if test="$paramTest = 'oui'">
