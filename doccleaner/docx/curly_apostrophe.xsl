...
<!-- XSL by @rboistel: https://github.com/rboistel romain.boistel@openedition.org -->
<!-- Replaces vertical apostrophes by curly apostrophes (' -> ’), per french typography rules -->
