...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    Sauf pour les hyperliens et les sections de code auxquels on ne touche pas.
    -->
    <xsl:template match="text()[not(ancestor::w:hyperlink)][not(ancestor::w:p/descendant::w:pStyle/@w:val = 'Code')]">
        <xsl:call-template name="manageSpaces">
